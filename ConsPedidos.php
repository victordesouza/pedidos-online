<?php 			// TELA HOME DO SISTEMA QUE MOSTRA PEDIDOS Jï¿½ FEITOS PELO REPRESENTANTE, COM A POSSIBILIDADE DE IMPRIMIR PEDIDO ESPECï¿½FICO
...
<tr>
	...
	<th id="pointer" <?php if($menuativo == 'emissao'){echo "class=ativo";}?> onClick="window.location.href = '?ordena=emissao'">Data Emissão</th>
